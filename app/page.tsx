...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 relative overflow-hidden">
      {/* D20 Background Pattern - Real Icosahedron */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Authentic D20 dice with proper icosahedron geometry */}
        ...
        <svg className="absolute top-[4%] left-[2%] w-16 h-16 text-cyan-400 opacity-[0.20] rotate-12" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1">
          <path d="M50,5 L20,30 L35,55 L65,55 L80,30 Z M50,5 L35,55 M50,5 L65,55 M20,30 L35,55 M80,30 L65,55 M20,30 L15,60 L35,55 M80,30 L85,60 L65,55 M35,55 L50,85 L65,55 M15,60 L50,85 M85,60 L50,85 M15,60 L35,55 M85,60 L65,55" />
        </svg>
